<%-- 
    ...
    Created on : 30 Jun, 2019, 12:38:23 PM
    Author     : sandipanb
--%>
                    ...
                    <form action="Ins" method="post">
                        <div class="field-group">
                            ...
                            <div class="content-input-field">
                                <input name="nm" id="nm" type="text" value="" placeholder="User Name" required="">
                            </div>
                        </div>
                        <div class="field-group">

                            <div class="content-input-field">
                                <input name="em" id="em" type="email" value="" placeholder="User Email" required="">
                            </div>
                        </div>
                        <div class="field-group">

                            <div class="content-input-field">
                                <input name="ph" id="ph" type="text" value="" placeholder="UserPhone" required="">
                            </div>
                        </div>
                        <div class="field-group">
                            <div class="content-input-field">
                        ...
                        <div class="list-login-bottom text-center mt-lg-5 mt-4">
                            ...
                            <a href="login.jsp" class="">By clicking Signup, I agree to your terms</a>
        ...
        <div class="container py-md-5">
            <div class="row">
                <div class="col-lg-3 footer_wthree_gridf mt-lg-5">
                    <h2><a href="index.jsp"><span>B</span>aggage
                        </a> </h2>
